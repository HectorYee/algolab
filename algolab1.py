...
# Question 1
def sum3():
    input = input("Enter three numbers here: ")
...
# Question 2
def got6():
    input = input("Enter a series of number: ")
    arr = [int(x) for x in input.split()]
    got6 = False
...
# Question 7
def biggest_two():
    input1 = input("Enter first array of two numbers: ")
    input2 = input("Enter second array of two numbers: ")
...
# Question 1
def mapBully():
    key_input  = input("Enter key value: ").split()
    value_input = input("Enter value: ").split()
    map = {}
...
# Question 2
def word0():
    input = input("Enter a string of keys: ").split()
